...
public class TestExamplePublisher extends Recorder {
    ...
    private final String report_location;
    private final String reportType;
    

    // Fields in config.jelly must match the parameter names in the "DataBoundConstructor"
    @DataBoundConstructor
    public TestExamplePublisher(String name, String token, String projects,
    		                    String suites, String releases, String build_number,
    		                    String report_location, String reportType) {
        this.name = name;
        this.token = token;
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        ...
        listener.getLogger().println(message + "build number " +  build.number);
