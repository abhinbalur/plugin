...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:testmaven:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","C:\\mavnedownload\\testmaven");
    parameters.put("artifactId","testmaven");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","C:\\mavnedownload\\testmaven\\target\\classes");
    parameters.put("testOutputDirectory","C:\\mavnedownload\\testmaven\\target\\test-classes");
